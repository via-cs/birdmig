...
The function fetches data from the csv files under the data folder in public/trajectory_data. The function first fetches all the tagged Bird IDs from the csv for the desired bird. Then,
...
the public/trajectory_data folder. Using Leaflet and the Leaflet plugin, L.heatLayer, a heat layer is generated showing the combined trajectory path of all the tagged birds on top of 
OpenStreetMap layer.  
